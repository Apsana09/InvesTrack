    ...
    <div className="container">
      ...
      <div className="row ms-5">
        ...
        <div className="col-6 mt-5 p-5">
          <img src="https://static.vecteezy.com/system/resources/thumbnails/022/659/646/small_2x/3d-growth-stock-diagram-financial-graph-isolated-on-transparent-background-business-candlestick-chart-investment-market-trade-exchange-analysis-and-economy-finance-report-png.png" alt="Stock Market" style={{ width: '70%', height: 'auto' }}/>
        </div>
